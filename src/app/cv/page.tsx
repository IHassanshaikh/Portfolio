                ...
                <div className="cv-layout">
                    ...
                    <div className="cv-main">
                        ...
                        <section>
                            ...
                            <div className="timeline">
                                ...
                                <div className="timeline-item">
                                    ...
                                    <ul className="timeline-content">
                                        <li>Developed niche platforms like <strong>The Jackets Designer</strong> (custom leather outerwear), <strong>Shapio</strong> (lingerie), <strong>VAT Formations</strong> (business services), and <strong>Milesouk</strong> (arbitrage).</li>
                        ...
                        <section>
                            ...
                            <div className="skill-category">
                                <div className="lang-item"><span className="lang-name"><FiAward style={{ marginRight: '0.5rem', color: 'rgb(var(--primary))' }} /> Top Rated Developer Award (Fiverr)</span></div>
                                <div className="lang-item"><span className="lang-name"><FiCheckCircle style={{ marginRight: '0.5rem', color: 'rgb(var(--primary))' }} /> Certified AI Workflow Specialist</span></div>
                            </div>
                        </section>
                    </div>
                </div>
