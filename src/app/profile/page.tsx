                ...
                <div className="profile-main">
                    ...
                    <div className="linkedin-card">
                        ...
                        <div className="profile-avatar-overlap">
                            <div style={{ width: '100%', height: '100%', background: '#444', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
                            ...
                            <div className="profile-name-section">
                                ...
                                <div style={{ textAlign: 'right', fontSize: '14px', fontWeight: 600 }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                                        <div style={{ width: '32px', height: '32px', background: '#333', borderRadius: '4px' }}></div>
                    ...
                    <div className="linkedin-card card-padding">
                        ...
                        <div style={{ fontSize: '14px', lineHeight: 1.6, color: '#efefef' }}>
                        ...
                        <div className="posts-list">
                            <div className="post-item">
                                <div className="post-content">
                                    ...
                                    <p style={{ fontSize: '14px', color: '#ccc' }}>.To God we belong and to Him we return</p>
                                </div>
                            </div>
                            <div className="post-item">
                                <div className="post-author-row">
                                    <div className="post-avatar" style={{ background: '#333' }}></div>
                                    <div>
                            ...
                            {[
                                ...
                                <div key={i} className="linkedin-list-item">
                                    <div className="item-logo">
                                        <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #333, #222)', color: '#ff4d4d' }}>
                                            <FiBriefcase size={24} />
                                        </div>
                                    </div>
                    ...
                    <div className="linkedin-card card-padding">
                        ...
                        <div className="linkedin-list">
                            {[
                                ...
                                <div key={i} className="linkedin-list-item">
                                    <div className="item-logo" style={{ background: '#333', borderRadius: '4px' }}></div>
                                    <div className="item-content">
                                        <h3>{cert.name}</h3>
                                        <span className="item-subtitle" style={{ color: '#fff' }}>{cert.issuer}</span>
                                        <span className="item-meta">{cert.date}</span>
                                        <div className="experience-skill-tag">
                                            <FiAward /> <span>{cert.skills}</span>
                                        </div>
                                        <div style={{ marginTop: '12px', padding: '8px', border: '1px solid #333', borderRadius: '4px', display: 'flex', alignItems: 'center', gap: '8px', width: 'fit-content' }}>
                                            <div style={{ width: '60px', height: '40px', background: '#222', borderRadius: '2px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '10px', color: '#444' }}>IMG</div>
